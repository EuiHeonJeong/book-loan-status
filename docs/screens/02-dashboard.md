...
- 상단 메뉴(햄버거) 아이콘: 클릭 시 "상호대차현황 / 일반예약현황 / 가족 관리 / 알림 설정 / 로그아웃" 드롭다운(Claude Design 핸드오프 순서에서 사용자 요청으로 조정, 2026-08-27)
...
- `DashboardPage`
  ...
  - `MenuDropdown` (오버레이 + 메뉴 아이템: 상호대차현황/일반예약현황/가족 관리/알림 설정/로그아웃)
